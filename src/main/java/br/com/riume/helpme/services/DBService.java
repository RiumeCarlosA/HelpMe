...
public class DBService {
	...
	public void instanciaDB() {
		Tecnico tec1 = new Tecnico(null, "Riume Carlos", "14094671986", "riumecarlos@gmail.com", "123");
		tec1.addPerfil(Perfil.ADMIN);
		
		Cliente cli1 = new Cliente(null, "Linus troval", "66021043065", "troval@gmail.com", "123");
		cli1.addPerfil(Perfil.CLIENTE);
		
		Chamado c1 = new Chamado(null, Prioridade.MEDIA, Status.ANDAMENTO, "Chamado 01", "Primeiro chamado", tec1, cli1);
		
		Tecnico tec2 = new Tecnico(null, "Vinicius", "10270411089", "vinicius@gmail.com", "123@123");
		tec2.addPerfil(Perfil.ADMIN);
		
		Cliente cli2 = new Cliente(null, "jao", "60677238088", "jao@gmail.com", "123@456");
